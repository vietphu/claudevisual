...
import {
  ...
  StatuslineCacheRecord,
} from "./hook-event-parsing";

export type { HookEventRecord, StatuslineCacheRecord } from "./hook-event-parsing";
export { deriveRunningState } from "./hook-event-parsing";
